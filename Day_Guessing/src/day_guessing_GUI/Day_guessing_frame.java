...
public class Day_guessing_frame extends JFrame {
   ...
   // Function: Inner class implementing ActionListener
   // Create by Yeasin Arafat
   // Description class to improve the redundant codes inside each Monday - Sunday button
...
// End of Inner class implementing ActionListener
   /**
